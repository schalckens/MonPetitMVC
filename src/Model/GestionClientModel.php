...
class GestionClientModel {
    ...
    public function enregistreClient($client) {
        ...
        $s->bindValue(':titreCli', $client->getNomCli(), PDO::PARAM_STR);
        $s->bindValue(':titreCli', $client->getPrenomCli(), PDO::PARAM_STR);
        $s->bindValue(':titreCli', $client->getAdresseRue1Cli(), PDO::PARAM_STR);
        $s->bindValue(':titreCli', ($client->getAdresseRue2Cli() == "") ? (null) : ($client->getAdresseRue2Cli()), PDO::PARAM_STR);
        $s->bindValue(':titreCli', $client->getCpCli(), PDO::PARAM_STR);
        $s->bindValue(':titreCli', $client->getVIlleCli(), PDO::PARAM_STR);
        $s->bindValue(':titreCli', $client->getTelCli(), PDO::PARAM_STR);
        $s->execute();
